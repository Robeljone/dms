...
<div class="flex min-h-full flex-col justify-left px-6 py-12 lg:px-8" style="margin-top: 100px">
    ...
    <div>
        <form  class="max-w-sm mx-auto"  id="loginfrm">
            ...
            <br>
            <div class="relative">
                <button type="submit" class="px-8 py-2 text-xs font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Login
                </button>
            </div>
        </form>
...
@isset($script)
    <script src="/js/dms/{{$script}}"></script>
@endisset
</html>
