                ...
                @for($i=1;$i<7;$i++)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-10 py-4"  style="align-items: center">
                            ...
                            <a href="#" id="openModalButton" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                            ...
                            <a href="subcity/detail" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
